...
class App extends Component {
  ...
  render() {
    return (
      <div className="app">
        <SushiContainer handleSushiClick={this.handleSushiClick} moreSushi={this.moreSushi} sushi={this.limitSushiRender()} wallet={this.state.wallet} eatenSushi={this.state.eatenSushi}/>
